...
macro(CheckWayland)
  if(SDL_WAYLAND)
    ...
    if(WAYLAND_FOUND)
      sdl_link_directories(PRIVATE ${PKG_WAYLAND_LIBRARY_DIRS})
      ...
      if(SDL_WAYLAND_LIBDECOR)
        ...
        if(PKG_LIBDECOR_FOUND)
            ...
            sdl_link_directories(PRIVATE ${PKG_LIBDECOR_LIBRARY_DIRS})
...
macro(CheckKMSDRM)
  if(SDL_KMSDRM)
    ...
    if(PKG_KMSDRM_FOUND AND HAVE_OPENGL_EGL)
      sdl_link_directories(PRIVATE ${PKG_KMSDRM_LIBRARY_DIRS})
