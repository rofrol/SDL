...
macro(CheckOSS)
  if(SDL_OSS)
    ...
    if(HAVE_OSS_SYS_SOUNDCARD_H)
      ...
      if(NETBSD)
        sdl_add_dependency(oss LIBS ossaudio)
      endif()
  ...
  if(SDL_ALSA)
    ...
    if(ALSA_FOUND)
      ...
      if(SDL_ALSA_SHARED)
        if(HAVE_SDL_LOADSO)
          ...
          if(ASOUND_LIB AND ASOUND_SHARED)
            sdl_add_dependency(alsa INCLUDES $<TARGET_PROPERTY:ALSA::ALSA,INTERFACE_INCLUDE_DIRECTORIES>)
      ...
      if(NOT HAVE_ALSA_SHARED)
        ...
        sdl_add_dependency(alsa LIBS ALSA::ALSA CMAKE_MODULE ALSA PKG_CONFIG_SPECS "${ALSA_PKG_CONFIG_SPEC}")
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  else()
...
macro(CheckPipewire)
  if(SDL_PIPEWIRE)
    ...
    if(PipeWire_FOUND)
      ...
      FindLibraryAndSONAME("pipewire-0.3" LIBDIRS ${PipeWire_LINK_DIRECTORIES})
      if(SDL_PIPEWIRE_SHARED AND PIPEWIRE_0.3_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_add_dependency(pipewire INCLUDES $<TARGET_PROPERTY:PipeWire::PipeWire,INTERFACE_INCLUDE_DIRECTORIES>)
      else()
        sdl_add_dependency(pipewire LIBS PipeWire::PipeWire CMAKE_MODULE PipeWire PKG_CONFIG_SPECS ${PIPEWIRE_PKG_CONFIG_SPEC})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
      endif()
    endif()
...
macro(CheckPulseAudio)
  if(SDL_PULSEAUDIO)
    ...
    if(PulseAudio_FOUND)
      ...
      FindLibraryAndSONAME("pulse-simple" LIBDIRS ${PulseAudio_LINK_DIRECTORIES})
      if(SDL_PULSEAUDIO_SHARED AND PULSE_SIMPLE_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_add_dependency(pulseaudio INCLUDES $<TARGET_PROPERTY:PulseAudio::PulseAudio,INTERFACE_INCLUDE_DIRECTORIES>)
      else()
        sdl_add_dependency(pulseaudio LIBS PulseAudio::PulseAudio CMAKE_MODULE PulseAudio ${PULSEAUDIO_PKG_CONFIG_SPEC})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
...
macro(CheckJACK)
  if(SDL_JACK)
    ...
    if(Jack_FOUND)
      ...
      FindLibraryAndSONAME("jack" LIBDIRS ${Jack_LINK_DIRECTORIES})
      if(SDL_JACK_SHARED AND JACK_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_add_dependency(jack INCLUDES $<TARGET_PROPERTY:Jack::Jack,INTERFACE_INCLUDE_DIRECTORIES>)
      else()
        sdl_add_dependency(jack LIBS Jack::Jack CMAKE_MODULE Jack PKG_CONFIG_SPECS ${Jack_PKG_CONFIG_SPEC})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
...
macro(CheckSNDIO)
  if(SDL_SNDIO)
    ...
    if(SndIO_FOUND)
      ...
      FindLibraryAndSONAME("sndio" LIBDIRS ${SndIO_LINK_DIRECTORIES})
      if(SDL_SNDIO_SHARED AND SNDIO_LIB AND HAVE_SDL_LOADSO)
        set(SDL_AUDIO_DRIVER_SNDIO_DYNAMIC "\"${SNDIO_LIB_SONAME}\"")
        set(HAVE_SNDIO_SHARED TRUE)
        sdl_include_directories(PRIVATE SYSTEM $<TARGET_PROPERTY:SndIO::SndIO,INTERFACE_INCLUDE_DIRECTORIES>)
      else()
        sdl_add_dependency(sndio LIBS SndIO::SndIO PKG_CONFIG_SPECS ${SndIO_PKG_CONFIG_SPEC} PKG_CONFIG_PREFIX PKG_SNDIO)
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
    ...
    if(X11_LIB)
      ...
      if(NOT HAVE_SHMAT_IN_LIBC)
        ...
        if(HAVE_SHMAT_IN_LIBIPC)
          sdl_add_dependency(x11_ipc LIBS ipc)
        endif()
      ...
      if(SDL_X11_SHARED)
        ...
        if(X11_LIB)
          if(HAVE_X11_SHARED)
            ...
            sdl_add_dependency(x11 LIBS X11::X11 CMAKE_MODULE X11 PKG_CONFIG_SPECS ${X11_PKG_CONFIG_SPEC})
          endif()
        endif()
        if(XEXT_LIB)
          if(HAVE_X11_SHARED)
            ...
            sdl_add_dependency(xext LIBS X11::Xext CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xext_PKG_CONFIG_SPEC})
          endif()
        endif()
      else()
        sdl_add_dependency(x11 LIBS X11::X11 CMAKE_MODULE X11 PKG_CONFIG_SPECS ${X11_PKG_CONFIG_SPEC})
      ...
      if(SDL_X11_XCURSOR AND HAVE_XCURSOR_H AND XCURSOR_LIB)
        ...
        if(HAVE_X11_SHARED)
          ...
          sdl_add_dependency(xcursor LIBS X11::Xcursor CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xcursor_PKG_CONFIG_SPEC})
        endif()
      ...
      if(SDL_X11_XINPUT AND HAVE_XINPUT2_H AND XI_LIB)
        ...
        if(HAVE_X11_SHARED)
          ...
          sdl_add_dependency(xi LIBS X11::Xi CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xi_PKG_CONFIG_SPEC})
        endif()
      ...
      if(SDL_X11_XFIXES AND HAVE_XFIXES_H AND HAVE_XINPUT2_H AND XFIXES_LIB)
        if(HAVE_X11_SHARED)
          ...
          sdl_add_dependency(xfixes LIBS X11::Xfixes CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xfixes_PKG_CONFIG_SPEC})
        endif()
      ...
      if(SDL_X11_XRANDR AND HAVE_XRANDR_H AND XRANDR_LIB)
        if(HAVE_X11_SHARED)
          ...
          sdl_add_dependency(xrandr LIBS X11::Xrandr CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xrandr_PKG_CONFIG_SPEC})
        endif()
      ...
      if(SDL_X11_XSCRNSAVER AND HAVE_XSS_H AND XSS_LIB)
        if(HAVE_X11_SHARED)
          ...
          sdl_add_dependency(xss LIBS X11::Xss CMAKE_MODULE X11 PKG_CONFIG_SPECS ${Xss_PKG_CONFIG_SPEC})
        endif()
  ...
  if(SDL_WAYLAND)
    ...
    if(WAYLAND_FOUND)
      ...
      if(SDL_WAYLAND_SHARED AND WAYLAND_CLIENT_LIB AND WAYLAND_EGL_LIB AND WAYLAND_CURSOR_LIB AND XKBCOMMON_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_add_dependency(wayland INCLUDES $<TARGET_PROPERTY:PkgConfig::PC_WAYLAND,INTERFACE_INCLUDE_DIRECTORIES>)
      else()
        sdl_add_dependency(wayland LIBS PkgConfig::PC_WAYLAND PKG_CONFIG_PREFIX PC_WAYLAND PKG_CONFIG_SPECS ${WAYLAND_PKG_CONFIG_SPEC})
      endif()

      if(SDL_WAYLAND_LIBDECOR)
        find_package(LibDecor MODULE)
        if(LibDecor_FOUND)
          ...
          FindLibraryAndSONAME(decor-0 LIBDIRS ${LibDecor_LINK_DIRECTORIES})
          if(SDL_WAYLAND_LIBDECOR_SHARED AND DECOR_0_LIB AND HAVE_SDL_LOADSO)
            ...
            sdl_add_dependency(libdecor INCLUDES $<TARGET_PROPERTY:LibDecor::LibDecor,INTERFACE_INCLUDE_DIRECTORIES>)
          else()
            sdl_add_dependency(libdecor LIBS LibDecor::LibDecor CMAKE_MODULE LibDecor PKG_CONFIG_SPECS ${LibDecor_PKG_CONFIG_SPEC})
          endif()

          cmake_push_check_state()
          list(APPEND CMAKE_REQUIRED_FLAGS ${LibDecor_COMPILE_OPTIONS})
          list(APPEND CMAKE_REQUIRED_INCLUDES ${LibDecor_INCLUDE_DIRS})
          list(APPEND CMAKE_REQUIRED_LIBRARIES ${LibDecor_LINK_LIBRARIES})
  ...
  if(SDL_VIVANTE)
    ...
    if(HAVE_VIVANTE_VDK OR HAVE_VIVANTE_EGL_FB)
      ...
      if(HAVE_VIVANTE_VDK)
        ...
        sdl_add_dependency(vivante LIBS ${VIVANTE_LIBRARY} ${VIVANTE_VDK_LIBRARY})
      else()
        ...
        sdl_add_dependency(vivante LIBS EGL)
...
macro(CheckEGL)
  if(SDL_OPENGL OR SDL_OPENGLES)
    ...
    if(HAVE_OPENGL_EGL)
      ...
      sdl_add_dependency(egl INCLUDES ${OPENGL_EGL_INCLUDE_DIRS})
    endif()
  endif()
endmacro()
...
macro(CheckQNXScreen)
  if(QNX AND HAVE_OPENGL_EGL)
    ...
    if(HAVE_QNX_SCREEN)
      ...
      sdl_add_dependency(qnxscreen LIBS screen EGL)
    endif()
  endif()
endmacro()
...
macro(CheckPTHREAD)
  ...
  if(SDL_THREADS AND SDL_PTHREADS)
    ...
    if(HAVE_PTHREADS)
      ...
      sdl_add_dependency(pthread LINK_OPTIONS ${PTHREAD_LDFLAGS})
      ...
      if(LibUSB_FOUND)
        ...
        if(HAVE_LIBUSB_H)
          ...
          if(HIDAPI_ONLY_LIBUSB)
            sdl_add_dependency(hidapi LIBS LibUSB::LibUSB CMAKE_MODULE LibUSB PKG_CONFIG_SPECS ${LibUSB_INCLUDE_DIRS})
          else()
            # libusb is loaded dynamically, so don't add link to it
            FindLibraryAndSONAME("usb-1.0" LIBDIRS ${LibUSB_LINK_DIRECTORIES})
            if(USB_1.0_LIB)
              set(SDL_LIBUSB_DYNAMIC "\"${USB_1.0_LIB_SONAME}\"")
            endif()
            sdl_add_dependency(hidapi INCLUDES $<TARGET_PROPERTY:LibUSB::LibUSB,INTERFACE_INCLUDE_DIRECTORIES>)
          endif()
        endif()
      endif()
...
macro(CheckRPI)
  if(SDL_RPI)
    ...
    if(RPi_BcmHost_FOUND)
      set(HAVE_RPI TRUE)
      sdl_add_dependency(rpi LIBS RPi_BcmHost::RPi_BcmHost CMAKE_MODULE RPi_BcmHost PKG_CONFIG_SPECS ${RPi_BcmHost_PKG_CONFIG_SPEC})
      find_package(RPi_BrcmEGL)
      if(SDL_VIDEO AND RPi_BrcmEGL_FOUND)
        set(HAVE_SDL_VIDEO TRUE)
        set(SDL_VIDEO_DRIVER_RPI 1)
        sdl_glob_sources("${SDL3_SOURCE_DIR}/src/video/raspberry/*.c")
        sdl_add_dependency(rpi-video LIBS RPi_BrcmEGL::RPi_BrcmEGL CMAKE_MODULE RPi_BrcmEGL PKG_CONFIG_SPECS ${RPi_BrcmEGL_PKG_CONFIG_SPEC})
      endif()
    endif()
  endif()
endmacro()
    ...
    if(PC_LIBDRM_FOUND AND PC_GBM_FOUND AND HAVE_OPENGL_EGL)
      ...
      if(SDL_KMSDRM_SHARED AND HAVE_SDL_LOADSO)
        ...
        if(DRM_LIB AND DRM_SHARED AND GBM_LIB AND GBM_SHARED)
          ...
          sdl_add_dependency(kmsdrm-drm INCLUDES $<TARGET_PROPERTY:PkgConfig::PC_LIBDRM,INTERFACE_INCLUDE_DIRECTORIES>)
          sdl_add_dependency(kmsdrm-gbm INCLUDES $<TARGET_PROPERTY:PkgConfig::PC_GBM,INTERFACE_INCLUDE_DIRECTORIES>)
        endif()
      endif()
      if(NOT HAVE_KMSDRM_SHARED)
        sdl_add_dependency(kmsdrm-libdrm LIBS PkgConfig::PC_LIBDRM PKG_CONFIG_PREFIX PC_LIBDRM PKG_CONFIG_SPECS ${PKG_CONFIG_LIBDRM_SPEC})
        sdl_add_dependency(kmsdrm-gbm LIBS PkgConfig::PC_GBM PKG_CONFIG_PREFIX PC_GBM PKG_CONFIG_SPECS ${PKG_CONFIG_GBM_SPEC})
      endif()
    endif()
  endif()
endmacro()
