...
macro(CheckRPI)
  if(SDL_RPI)
    ...
    cmake_push_check_state()
    message(CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS} ${VIDEO_RPI_INCLUDE_FLAGS}")
    message(APPEND CMAKE_REQUIRED_LIBRARIES ${VIDEO_RPI_LDFLAGS} ${VIDEO_RPI_LIBRARIES})
    set(CMAKE_REQUIRED_FLAGS "${CMAKE_REQUIRED_FLAGS} ${VIDEO_RPI_INCLUDE_FLAGS}")
    list(APPEND CMAKE_REQUIRED_LIBRARIES ${VIDEO_RPI_LDFLAGS} ${VIDEO_RPI_LIBRARIES})
    check_c_source_compiles("
        #include <bcm_host.h>
