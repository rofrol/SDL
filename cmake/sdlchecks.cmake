  ...
  if(SDL_PIPEWIRE)
    ...
    if(PipeWire_FOUND)
      ...
      if(SDL_PIPEWIRE_SHARED AND PIPEWIRE_0.3_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_link_dependency(pipewire INCLUDES $<TARGET_PROPERTY:PipeWire::PipeWire,INTERFACE_INCLUDE_DIRECTORIES>)
      else()
        sdl_link_dependency(pipewire LIBS PipeWire::PipeWire CMAKE_MODULE PipeWire PKG_CONFIG_SPECS ${PIPEWIRE_PKG_CONFIG_SPEC})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
      endif()
    endif()
  ...
  if(SDL_PULSEAUDIO)
    ...
    if(PulseAudio_FOUND)
      ...
      if(SDL_PULSEAUDIO_SHARED AND PULSE_SIMPLE_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_link_dependency(pulseaudio INCLUDES $<TARGET_PROPERTY:PulseAudio::PulseAudio,INTERFACE_INCLUDE_DIRECTORIES>)
      else()
        sdl_link_dependency(pulseaudio LIBS PulseAudio::PulseAudio CMAKE_MODULE PulseAudio ${PULSEAUDIO_PKG_CONFIG_SPEC})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
  ...
  if(SDL_JACK)
    ...
    if(Jack_FOUND)
      ...
      if(SDL_JACK_SHARED AND JACK_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_link_dependency(jack INCLUDES $<TARGET_PROPERTY:Jack::Jack,INTERFACE_INCLUDE_DIRECTORIES>)
      else()
        sdl_link_dependency(jack LIBS Jack::Jack CMAKE_MODULE Jack PKG_CONFIG_SPECS ${Jack_PKG_CONFIG_SPEC})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
  ...
  if(SDL_SNDIO)
    ...
    if(SndIO_FOUND)
      ...
      if(SDL_SNDIO_SHARED AND SNDIO_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_link_dependency(sndio LIBS SndIO::SndIO PKG_CONFIG_SPECS ${SndIO_PKG_CONFIG_SPEC} PKG_CONFIG_PREFIX PKG_SNDIO)
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
      ...
      if(SDL_WAYLAND_LIBDECOR)
        ...
        if(LibDecor_FOUND)
          ...
          if(SDL_WAYLAND_LIBDECOR_SHARED AND DECOR_0_LIB AND HAVE_SDL_LOADSO)
            ...
            sdl_link_dependency(libdecor INCLUDES $<TARGET_PROPERTY:LibDecor::LibDecor,INTERFACE_INCLUDE_DIRECTORIES>)
          else()
            sdl_link_dependency(libdecor LIBS LibDecor::LibDecor CMAKE_MODULE LibDecor PKG_CONFIG_SPECS ${LibDecor_PKG_CONFIG_SPEC})
          endif()
      ...
      if(LibUSB_FOUND)
        ...
        if(HAVE_LIBUSB_H)
          ...
          if(HIDAPI_ONLY_LIBUSB)
            sdl_link_dependency(hidapi LIBS LibUSB::LibUSB CMAKE_MODULE LibUSB PKG_CONFIG_SPECS ${LibUSB_INCLUDE_DIRS})
          else()
