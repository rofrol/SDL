    ...
    if(SDL_PIPEWIRE)
        ...
        if(PKG_PIPEWIRE_FOUND)
            ...
            if(SDL_PIPEWIRE_SHARED AND PIPEWIRE_0.3_LIB AND HAVE_SDL_LOADSO)
                ...
                sdl_private_link_options(${PKG_PIPEWIRE_LDFLAGS})
            endif()
            set(HAVE_SDL_AUDIO TRUE)
        endif()
    endif()
  ...
  if(SDL_PULSEAUDIO)
    ...
    if(PKG_PULSEAUDIO_FOUND)
      ...
      if(SDL_PULSEAUDIO_SHARED AND PULSE_SIMPLE_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_private_link_options(${PKG_PULSEAUDIO_LDFLAGS})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
  ...
  if(SDL_JACK)
    ...
    if(PKG_JACK_FOUND)
      ...
      if(SDL_JACK_SHARED AND JACK_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_private_link_options(${PKG_JACK_LDFLAGS})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
  ...
  if(SDL_LIBSAMPLERATE)
    ...
    if(SampleRate_FOUND AND TARGET SampleRate::samplerate)
      ...
      if(SDL_LIBSAMPLERATE_SHARED)
        ...
        sdl_link_libraries(PRIVATE $<BUILD_INTERFACE:SampleRate::samplerate>)
      endif()
    else()
  ...
  if(SDL_VIVANTE)
    ...
    if(HAVE_VIVANTE_VDK OR HAVE_VIVANTE_EGL_FB)
      ...
      if(HAVE_VIVANTE_VDK)
        ...
        sdl_compile_definitions(PRIVATE LINUX EGL_API_FB)
...
macro(CheckPTHREAD)
  ...
  if(SDL_THREADS AND SDL_PTHREADS)
    ...
    if(HAVE_PTHREADS)
      ...
      sdl_private_link_options(${PTHREAD_LDFLAGS})
...
macro(CheckRPI)
  if(SDL_RPI)
    ...
    if(SDL_VIDEO AND HAVE_RPI)
      ...
      sdl_private_link_options(${VIDEO_RPI_LIBRARY_FLAGS} ${VIDEO_RPI_LDFLAGS})
    endif()
  endif()
endmacro()
