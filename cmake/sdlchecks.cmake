...
macro(CheckSNDIO)
  if(SDL_SNDIO)
    ...
    if(PKG_SNDIO_FOUND)
      ...
      target_include_directories(sdl-build-options SYSTEM INTERFACE ${PKG_SNDIO_INCLUDE_DIRS})
...
macro(CheckX11)
  ...
  if(SDL_X11)
    ...
    if(X_INCLUDEDIR)
      target_include_directories(sdl-build-options SYSTEM INTERFACE "${X_INCLUDEDIR}")
