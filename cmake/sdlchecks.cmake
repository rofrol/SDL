    ...
    if(SDL_PIPEWIRE)
        ...
        if(PKG_PIPEWIRE_FOUND)
            ...
            if(SDL_PIPEWIRE_SHARED AND PIPEWIRE_0.3_LIB AND HAVE_SDL_LOADSO)
                ...
                sdl_link_options(${PKG_PIPEWIRE_LDFLAGS})
            endif()
            set(HAVE_SDL_AUDIO TRUE)
        endif()
    endif()
  ...
  if(SDL_PULSEAUDIO)
    ...
    if(PKG_PULSEAUDIO_FOUND)
      ...
      if(SDL_PULSEAUDIO_SHARED AND PULSE_SIMPLE_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_link_options(${PKG_PULSEAUDIO_LDFLAGS})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
  ...
  if(SDL_JACK)
    ...
    if(PKG_JACK_FOUND)
      ...
      if(SDL_JACK_SHARED AND JACK_LIB AND HAVE_SDL_LOADSO)
        ...
        sdl_link_options(${PKG_JACK_LDFLAGS})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
  ...
  if(SDL_SNDIO)
    ...
    if(PKG_SNDIO_FOUND)
      ...
      if(SDL_SNDIO_SHARED AND SNDIO_LIB AND HAVE_SDL_LOADSO)
        ...
        # FIXME: use sdl_link_options
        sdl_link_libraries(${PKG_SNDIO_LDFLAGS})
      endif()
      set(HAVE_SDL_AUDIO TRUE)
    endif()
  endif()
    ...
    if(X11_LIB)
      ...
      if(SDL_X11_SHARED)
        ...
        if(X11_LIB)
          if(HAVE_X11_SHARED)
            ...
            # FIXME: use sdl_link_directories
            sdl_link_options("-L${X11_LIBDIR}")
        ...
        if(XEXT_LIB)
          if(HAVE_X11_SHARED)
            ...
            # FIXME: use sdl_link_directories
            sdl_link_options("-L${XEXT_LIBDIR}")
            sdl_link_libraries(Xext)
          endif()
        endif()
      else()
        # FIXME: use sdl_link_directories
          sdl_link_options("-L${X11_LIBDIR}" "-L${XEXT_LIBDIR}")
      ...
      if(SDL_X11_XCURSOR AND HAVE_XCURSOR_H AND XCURSOR_LIB)
        ...
        if(HAVE_X11_SHARED)
          ...
          # FIXME: use sdl_link_directories
          sdl_link_options("-L${XCURSOR_LIBDIR}")
      ...
      if(SDL_X11_XFIXES AND HAVE_XFIXES_H AND HAVE_XINPUT2_H AND XFIXES_LIB)
        if(HAVE_X11_SHARED)
          ...
          # FIXME: use sdl_link_directories
          sdl_link_options("-L${XFIXES_LIBDIR}")
      ...
      if(SDL_X11_XRANDR AND HAVE_XRANDR_H AND XRANDR_LIB)
        if(HAVE_X11_SHARED)
          ...
          # FIXME: use sdl_link_directories
          sdl_link_options("-L${XRANDR_LIBDIR}")
...
macro(CheckRPI)
  if(SDL_RPI)
    ...
    if(SDL_VIDEO AND HAVE_RPI)
      ...
      sdl_link_options(${VIDEO_RPI_LIBRARY_FLAGS} ${VIDEO_RPI_LDFLAGS})
    endif()
  endif()
endmacro()
