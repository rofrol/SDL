...
function(sdl_glob_sources)
  ...
  source_group(TREE "${SDL3_SOURCE_DIR}/src" FILES ${shared_sources} ${static_sources} ${both_sources})
...
function(sdl_sources)
  cmake_parse_arguments(ARGS "" "" "SHARED;STATIC" ${ARGN})
  source_group(TREE "${SDL3_SOURCE_DIR}/src" FILES ${ARGS_SHARED} ${ARGS_STATIC} ${ARGS_UNPARSED_ARGUMENTS})
  if(TARGET SDL3-shared)
