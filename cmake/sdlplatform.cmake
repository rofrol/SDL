macro(SDL_DetectCMakePlatform)
  ...
  # Get the platform
  if(WIN32)
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "windows")
    set(SDL_CMAKE_PLATFORM Windows)
  elseif(PSP)
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "psp")
    set(SDL_CMAKE_PLATFORM psp)
  elseif(RISCOS)
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "riscos")
    set(SDL_CMAKE_PLATFORM riscos)
  elseif(APPLE)
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "apple")
  ...
  elseif(CMAKE_SYSTEM_NAME MATCHES "Haiku.*")
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "haiku")
    set(SDL_CMAKE_PLATFORM Haiku)
  elseif(NINTENDO_3DS)
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "n3ds")
    set(SDL_CMAKE_PLATFORM n3ds)
  elseif(PS2)
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "ps2")
    set(SDL_CMAKE_PLATFORM ps2)
  elseif(VITA)
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "vita")
    set(SDL_CMAKE_PLATFORM Vita)
  elseif(CMAKE_SYSTEM_NAME MATCHES ".*Linux")
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "unix")
  ...
  elseif(CMAKE_SYSTEM_NAME MATCHES "Android.*")
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "android")
    set(SDL_CMAKE_PLATFORM Android)
  elseif(CMAKE_SYSTEM_NAME MATCHES "Emscripten.*")
    set(SDL_CMAKE_PLATFORM_FILENAME_DEFAULT "emscripten")
  ...
  message(DEBUG "SDL_CMAKE_PLATFORM_FILENAME_DEFAULT=${SDL_CMAKE_PLATFORM_FILENAME_DEFAULT}")
  message(DEBUG "SDL_CMAKE_PLATFORM=${SDL_CMAKE_PLATFORM}")
