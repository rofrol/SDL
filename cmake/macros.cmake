...
function(sdl_link_directories)
  ...
  if(ARG_SHARED)
    target_link_directories(sdl-shared-build-options INTERFACE ${ARG_UNPARSED_ARGUMENTS})
  endif()
  if(ARG_STATIC)
    target_link_directories(sdl-static-build-options INTERFACE ${ARG_UNPARSED_ARGUMENTS})
  endif()
endfunction()

function(sdl_link_options)
  cmake_parse_arguments(ARG "SHARED;STATIC" "" "" ${ARGN})
  if(NOT ARG_SHARED AND NOT ARG_STATIC)
    set(ARG_SHARED TRUE)
    set(ARG_STATIC TRUE)
  ...
  if(ARG_SHARED)
    target_link_options(sdl-shared-build-options INTERFACE ${ARG_UNPARSED_ARGUMENTS})
  endif()
  if(ARG_STATIC)
    target_link_options(sdl-static-build-options INTERFACE ${ARG_UNPARSED_ARGUMENTS})
  endif()
endfunction()
